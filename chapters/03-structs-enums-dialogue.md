...
> 👩‍💻 **ユイ**: 「先輩、Rustでユーザー情報とかをまとめるときって、クラス使うんですよね？」
>
> 👩‍🏫 **レイ**: 「あー…それがね、Rustには**クラスがない**のよ。」
>
> 👩‍💻 **ユイ**: 「えっ！？クラスないんですか！？じゃあどうやってデータとメソッドをまとめるんですか！？」
>
> 👩‍🏫 **レイ**: 「**構造体（struct）**と**実装（impl）**を使うの。データとメソッドを**分離して定義**するのよ。」
>
> 👩‍💻 **ユイ**: 「分離…？ちょっと待ってください、私Pythonでもクラス使ってましたし、TypeScriptでも class で書いてました。それができないって、かなり不便じゃないですか？」
>
> 👩‍🏫 **レイ**: 「最初はそう感じるかもしれないわね。でも実は、**クラスがないことには明確な理由がある**の。ホワイトボード使って説明するわね。」
...
> 👩‍💻 **ユイ**: 「あっ、『継承より合成』って聞いたことあります！」
>
> 👩‍🏫 **レイ**: 「そう。GoFが1994年にその原則を提唱して、でも当時の言語（Java, C++）は継承が言語の中心だったから、プログラマの『心がけ』に頼るしかなかったの。」
>
> 👩‍💻 **ユイ**: 「で、Rustはどうしたんですか？」
>
> 👩‍🏫 **レイ**: 「**言語レベルで継承を排除した**の。2010年代に設計された言語として、過去の教訓を活かしたのよ。代わりに**トレイト**と**合成**でコードを再利用する。強制的に『良い設計』しかできないようにしたの。」
>
> 👩‍💻 **ユイ**: 「なるほど…！言語が設計ミスを防いでくれるってことですね。」
>
> 👩‍🏫 **レイ**: 「その通り。Rustは『プログラマを信用しない』言語なのよ。いい意味でね。」
