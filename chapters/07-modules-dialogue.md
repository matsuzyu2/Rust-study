...
> 👩‍💻 **ユイ**: 「先輩、Rustのプロジェクトが大きくなってきたんですけど、コードをどうやって整理したらいいですか？今は全部main.rsに詰め込んでるんですけど…」
>
> 👩‍🏫 **レイ**: 「あー、それはモジュールシステムを使うといいよ！TypeScriptでファイルを分けて`import`するみたいに、Rustでもコードを整理できるの。」
>
> 👩‍💻 **ユイ**: 「TypeScriptのimportみたいなものがあるんですか？」
>
> 👩‍🏫 **レイ**: 「そう！でも、Rustのモジュールシステムはちょっと独特なのよね。その前に、Rustのパッケージマネージャ『Cargo』の話をしておこうかしら。」
...
> 👩‍💻 **ユイ**: いろいろ学んだけど、頭の中を整理したいな...

> 👩‍🏫 **レイ**: じゃあ、Python・TypeScript・Rustを比較してまとめようか。
...
> 👩‍🏫 **レイ**: Rustのモジュールシステムの重要なポイントをまとめるね:
...
> 👩‍💻 **ユイ**: TypeScriptと比べると、ちょっと面倒な気もするけど...

> 👩‍🏫 **レイ**: そうだね。でも、この「厳格さ」がRustの安全性につながってるんだ。どの関数が公開されてるか、どのモジュールから来たのか、全部明確になるからね。

> 👩‍💻 **ユイ**: 確かに、大規模プロジェクトだと「どこから来た関数か分からない」って問題が起きにくそうだね。

> 👩‍🏫 **レイ**: その通り！最初は面倒に感じるかもしれないけど、慣れてくると「この厳格さが心地いい」って思えるようになるよ。
